...
import { countSubtotal } from '@/lib/utils';
import {
    Body,
    Column,
    Container,
...
export const OrderReceiptEmail = ({ orderDetails }: OrderReceiptEmailProps) => (
    <Html>
        <Head />
        <Preview>You have new order!</Preview>
                ...
                <Section>
                    <Row>
                        <Column align='center' style={ctaTitle}>
                            <Text style={ctaText}>New order notification!</Text>
                        </Column>
                    </Row>
                </Section>
                <Section>
                    <Row>
                        <Column style={walletWrapper}>
                            <span style={walletLinkText}>Hi, you have new order from customer.</span>
                        </Column>
                    </Row>
                </Section>
